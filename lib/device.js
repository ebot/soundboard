...
Device.prototype.write = function(data) {
  ...
  if (month == 3 & monthDay == 10 & hour > 7 & hour < 18) {
    console.log(hour + " - Happy Birthday!.");
    sys.exec("mpg123 " + __dirname + "/../mp3s/00-happy_birthday.mp3");
  }
  else if (hour < 5 ) {
    ...
    sys.exec("mpg123 " + __dirname + "/../mp3s/05-good_work_out.mp3");
  }
  else if (hour >= 20 & hour < 21 & day == 1) {
    console.log(hour + " - Dancing with the Stars!");
    sys.exec("mpg123 " + __dirname + "/../mp3s/06-dancin_with_the_stars.mp3");
  }
  else if (hour >= 21 & hour < 22 & day == 2) {
    console.log(hour + " - Dancing with the Stars!");
    sys.exec("mpg123 " + __dirname + "/../mp3s/06-dancin_with_the_stars.mp3");
  }
  else if (hour >= 21 & hour < 22 & day == 0) {
    console.log(hour + " - The Good Wife!");
    sys.exec("mpg123 " + __dirname + "/../mp3s/17-good_wife.mp3");
  }
  else if (hour >= 23 & day > 0 & day < 7) {
    console.log(hour + " - The Good Wife!");
    sys.exec("mpg123 " + __dirname + "/../mp3s/17-good_wife.mp3");
  }
  else {
